# alb/main.tf
#
# Creates an Application Load Balancer, a default target group, and an HTTP
# listener. An HTTPS listener is only created once acm_certificate_arn is
# supplied. Reuses the existing alb security group created by the vpc module
