...
```
User (gds-users account, GDS_USERS_ACCOUNT_ID)
  │
...
role_arn = arn:aws:iam::PRODUCTION_ACCOUNT_ID:role/gds-aidr-admin
...
role_arn = arn:aws:iam::DEVELOPMENT_ACCOUNT_ID:role/gds-aidr-readonly
source_profile = gds-users
mfa_serial = arn:aws:iam::GDS_USERS_ACCOUNT_ID:mfa/<your-username>
duration_seconds = 14400
region = eu-west-2
...
eval $(aws sts assume-role \
  --role-arn "arn:aws:iam::PRODUCTION_ACCOUNT_ID:role/gds-aidr-admin" \
  --role-session-name "TerraformSession" \
  --serial-number "arn:aws:iam::GDS_USERS_ACCOUNT_ID:mfa/<your-username>" \
